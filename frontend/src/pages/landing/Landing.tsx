...
const Landing = () => {
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <section id="hero" className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight mb-6 bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">
            ...
            <div className="relative">
              ...
              <div className="relative bg-card border border-border rounded-xl p-8 shadow-xl">
                <h3 className="text-xl font-semibold mb-6">Try it now:</h3>
                <TypingDemo />
      ...
      {/* Footer */}
      <footer className="bg-card py-12 px-4 sm:px-6 lg:px-8 mt-auto border-t border-border">
        ...
        <div className="pt-8 mt-8 border-t border-border flex flex-col sm:flex-row justify-between items-center">
