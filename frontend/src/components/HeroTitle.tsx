...
const HeroTitle = () => {
  return (
    <div className="relative">
      ...
      >
        Be the maestro of AI orchestration. Direct specialized agents to work in perfect symphony, creating powerful workflows that transform your ideas into reality.
      </motion.p>
    </div>
  );
};
